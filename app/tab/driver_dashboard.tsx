  ...
  const fetchData = useCallback(
    async (showLoading = false) => {
      ...
      try {
        ...
        const deliveringOrder = myOrders.find(
          (o: any) => o.status === "DELIVERING",
        );
        ...
        { text: "Annuler", style: "cancel" },
        {
          ...
          onPress: async () => {
            ...
            if (success) {
              Toast.show({
                type: "success",
                text1: "Bravo ! Livraison terminÃ©e.",
                position: "top",
              });
              setActiveOrder(null);
      ...
      {!isAvailable && (
        <View style={styles.warningBox}>
          ...
          <Text style={styles.warningText}>
            Vous devez Ãªtre "En ligne" pour voir les commandes disponibles.
          </Text>
        </View>
      )}
      ...
      {availableOrders.length === 0 ? (
        <View style={styles.emptyState}>
          ...
          <Text style={styles.emptySubText}>
            Les nouvelles commandes s'afficheront ici.
          </Text>
        </View>
      ) : (
          ...
          <View style={styles.statBox}>
            <Text style={styles.statValue}>
              {historyOrders.length > 0
                ? Math.round(
                    totalEarnings / historyOrders.length,
                  ).toLocaleString()
                : 0}
            </Text>
      ...
      {!activeOrder ? (
        ...
        <View style={styles.activeCard}>
          ...
          <View style={styles.infoSection}>
            ...
            <Text style={styles.addressBig}>
              {activeOrder.deliveryAddress.address}
            </Text>
          </View>

          <View style={styles.infoSection}>
            <Text style={styles.sectionTitle}>ðŸ›ï¸ CONTENU</Text>
          ...
          <View style={styles.gpsIndicator}>
            <View
              style={[styles.pulseCircle, { backgroundColor: "#12d743" }]}
            />
            <Text style={styles.gpsText}>
              GPS Actif - Le client voit votre position
            </Text>
          </View>
          ...
          >
            <Text style={styles.completeBtnText}>Livraison terminÃ©e</Text>
          </TouchableOpacity>
        </View>
      )}
      <View style={{ height: 100 }} />
        ...
        <View style={styles.availabilityRow}>
          <Text
            style={[
              ...
              { color: isAvailable ? "#00b81c" : "#636e72" },
            ]}
          >
          ...
          <Switch
            ...
            trackColor={{ true: "#9de99c", false: "#eeafa5" }}
            thumbColor={isAvailable ? "#00ad5f" : "#e43a0b"}
